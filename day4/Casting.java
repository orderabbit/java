...
public class Casting {
    public static void main(String[] args) {
        ...
        int c = (int) 3.14; // 형변환 X => double이 int로 바뀌려면 소수점 떼야됨 (수동형변환)
        ...
        Cat c2 = (Cat)a2; // 자동 형변환 X. a2에는 Catr과 Dog가 들어있을 수 있기 떄문에 Cat이라고 확신할 수 없다.
                          // 상위타입을 하위타입으로 바꾸는 건 위험하기 때문에 개발자가 직접 수동형변환을 해야함
        c2.meow();
    }
}
